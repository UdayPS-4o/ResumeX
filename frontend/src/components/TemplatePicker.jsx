      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-4">
          ...
          >
            ...
            {imported ? (
              <>
                <div className="text-sm font-semibold text-emerald-700">&ldquo;{imported.filename}&rdquo; imported</div>
...
function TemplateCard({ template, selected, onSelect }) {
  ...
  return (
    ...
    >
      {/* Preview — scaled to A4 proportions */}
      <div className="relative bg-white" style={{ aspectRatio: '210 / 297' }}>
        ...
        {!selected && (
          <div className="absolute inset-0 bg-brand-600/0 group-hover:bg-brand-600/5 transition-colors opacity-0 group-hover:opacity-100">
          </div>
        )}
      </div>
