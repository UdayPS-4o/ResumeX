// Shared resume helpers: merging AI patches, diffing for suggestions, and
// detecting whether a resume has any real content.

import { emptyResume } from './storage.js';

// Merge an AI-proposed patch into the working resume. Mirrors the backend's
// mergeResume so the result matches what the server computed: arrays are
// replaced wholesale (the model owns each section), contact is shallow-merged.
