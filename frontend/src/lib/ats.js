// Deterministic ATS checks — a frontend port of backend/src/services/atsChecks.js
// so we can show a live score instantly on every resume change, with no network.
